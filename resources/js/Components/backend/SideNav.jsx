...
import SingleMenu from "@/Components/backend/menu/SingleMenu";
import MenuDevider from "@/Components/backend/menu/MenuDevider";
import NestedMenu from "@/Components/backend/menu/NestedMenu";

export default function SideNav({type = 'submit', className = '', processing, children}) {
    return (<div id="kt_aside" className="aside aside-dark aside-hoverable" data-kt-drawer="true"
        ...
        <div className="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
            <a href="documentation/getting-started.html" className="btn btn-custom btn-primary w-100"
